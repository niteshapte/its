...
import com.discovery.interstellar.transport.system.controller.InterstellarController;
...
public class InterstellarControllerTest {
    ...
    View mockView;
    @InjectMocks
    private InterstellarController controller;
    @Mock
    ...
    public void setUpFixture() {
        mockMvc = standaloneSetup(
                new InterstellarController(entityManagerService, shortestPathService)
        )
